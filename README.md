...
> 2026-09-15 托管部署：API、相机监控、GPU OCR、NAS 归档拆分运行，统一账号权限、持久化租约队列和测量确认流程；NAS 使用 PascalCase 分类索引与单份记录。新部署以 [托管运行说明](docs/ProductionRuntime.md) 为准，以下单进程命令保留用于隔离开发。
